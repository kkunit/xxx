          ...
          >
            ...
            <div className="space-y-3 text-sm text-gray-600 leading-relaxed">
              <p>
                ...
                <br />
                复制下面的地址或者直接使用手机的分享面板，把糖果信箱发给朋友吧～
              </p>
              {shareUrl ? (
                <div className="bg-pink-50 border border-pink-200 rounded-2xl p-3 space-y-2">
                  <code className="block text-xs break-words text-pink-700">{shareUrl}</code>
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 bg-pink-500 text-white py-2 rounded-xl text-sm font-semibold shadow hover:bg-pink-600 transition-colors"
                    >
                    ...
                    {canUseShare && (
                      <button
                        ...
                        onClick={async () => {
                          try {
                            await navigator.share({ title: '糖果信箱', url: shareUrl });
                          } catch (error) {
                        ...
                        className="flex-1 bg-white text-pink-500 border border-pink-300 py-2 rounded-xl text-sm font-semibold shadow-sm hover:bg-pink-50 transition-colors"
                      >
                        打开分享面板
                      </button>
                    )}
              ...
              <p className="text-xs text-gray-500 bg-amber-50 border border-amber-200 rounded-xl p-2">
                小贴士：暗号是主人才能告诉的秘密，不要写在公开页面里，悄悄告诉收信的朋友就好～
              </p>
            </div>
            <button
              onClick={() => setShowShareHelp(false)}
